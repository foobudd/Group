...
<div class="col-md-4">
        <form name='basic' method='POST' action='reviews.php' onSubmit='return validate();'>
                <table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                         ...
                         <tr><td>Person ID: </td><td><input type='edit' name='person_id' value='' size='11'></td></tr>
                         <tr><td>Lesson ID: </td><td><input type='edit' name='lesson_id' value='' size='11'></td></tr>
                         <tr><td>Title: </td><td><input type='edit' name='title' value='' size='50'></td></tr>
